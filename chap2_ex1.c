...
static void inline AddI16_AVX(_In_ const xmm_t* arr_packed_0, _In_ const xmm_t* arr_packed_1,
    ...
    _mm_store_si128((__m128i*) flpar_sums, xmm_fliparound_sum);
    _mm_store_si128((__m128i*) sat_sums, xmm_saturated_sum);
...
static void inline AddU16_AVX(_In_ const xmm_t* arr_packed_0, _In_ const xmm_t* arr_packed_1,
    ...
    __m128i xmm_fliparound_sum = _mm_add_epi16(xmm_arr0, xmm_arr1);
    __m128i xmm_saturated_sum = _mm_adds_epu16(xmm_arr0, xmm_arr1);
